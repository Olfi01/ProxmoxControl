...
namespace ProxmoxControl.Commands
{
    public class BotCommands
    {
        ...
        private static void SendQemuVms(int page, string node, Message message, BotClient tg, PveClient pve)
        {
        ...
        private static void Qemu(string node, Message message, BotClient tg, PveClient pve)
        {
